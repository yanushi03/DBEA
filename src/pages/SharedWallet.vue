      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center">
          <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
            <path fill-rule="evenodd" clip-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 
        ...
        <button @click="errorMessage = ''" class="text-red-700 hover:text-red-900">
          <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
            <path fill-rule="evenodd" clip-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 
            ...
            <button class="p-2 hover:bg-purple-700 rounded-lg transition-colors" @click="toggleSharedBalance">
              <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <template v-if="sharedBalanceVisible">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 
                    11-6 0 3 3 0 016 0z" />
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 
        ...
        <div>
          ...
          <ModalComponent v-if="showModal" :modal-title="'Add User to Wallet'" @close="closeModal">
            <form @submit.prevent="handleAddMember" class="space-y-4">
              <label class="block text-sm font-medium">
                User Account ID:
                <input v-model="newUserID" type="text" placeholder="Enter Account ID"
