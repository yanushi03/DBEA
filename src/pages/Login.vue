<template>
  <div
    class="min-h-screen flex items-center justify-center bg-gradient-to-br from-navy-50 to-navy-100"
  >
    <div class="bg-white shadow-md rounded-lg p-8 w-full max-w-md">
      ...
      <!-- Title -->
      <h2 class="text-2xl font-bold text-center text-navy-900 mb-6">
      ...
      <form @submit.prevent="handleLogin" class="space-y-4">
        ...
        <div>
          <label class="block text-navy-900 font-medium mb-1" for="password"
            >Password</label
          >
          <input
            v-model="password"
...
import { setLoggedIn } from "../router/auth.js";
